        ...
        <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 flex-col justify-between p-4 z-40 bg-surface-container border-r border-outline-variant">
          <div className="flex flex-col gap-6">
            ...
            <nav className="flex flex-col gap-1">
              <Link href="/dashboard" className="flex items-center gap-4 px-4 py-3 rounded-lg text-primary font-bold bg-primary-container/20 transition-all duration-200">
                <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>dashboard</span>
                <span className="text-sm font-medium">Dashboard</span>
              </Link>
              <Link href="/revision" className="flex items-center gap-4 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-variant hover:text-on-surface transition-all duration-200">
                <span className="material-symbols-outlined">event_note</span>
                <span className="text-sm font-medium">Revision Plan</span>
              </Link>
              <Link href="/mastery" className="flex items-center gap-4 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-variant hover:text-on-surface transition-all duration-200">
                <span className="material-symbols-outlined">verified</span>
                <span className="text-sm font-medium">Mastery</span>
              </Link>
              <Link href="/login" className="flex items-center gap-4 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-variant hover:text-on-surface transition-all duration-200">
          ...
          <div className="p-3 bg-surface-container-low rounded-xl flex items-center gap-4 border border-outline-variant/30">
            ...
            <div className="overflow-hidden">
              <p className="text-sm font-medium text-on-surface truncate">Student</p>
              <p className="text-xs text-on-surface-variant truncate">Learner</p>
            </div>
          </div>
        </aside>
